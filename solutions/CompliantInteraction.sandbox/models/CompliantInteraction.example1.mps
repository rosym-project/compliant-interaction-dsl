...
<model ref="r:e1a10b50-7621-497c-b9df-af583ed62f9d(CompliantInteraction.example1)">
  ...
  <node concept="ULbc8" id="3gyK6Xv0EW1">
    ...
    <property role="TrG5h" value="MotionTracking" />
  ...
  <node concept="btvZb" id="3gyK6Xv0F2u">
    ...
    <node concept="b3D_K" id="3gyK6Xv0F2D" role="btvZ4">
      <ref role="b3D_P" node="3gyK6Xv0EZp" resolve="frame_motion" />
    </node>
